...
describe('KbDialog', () => {
  it('modelValue=false 时不渲染', () => {
    const wrapper = mount(
      KbDialog,
      { props: { modelValue: false }, slots: { default: '内容' }, ...stubTeleport },
    )
  ...
  it('modelValue=true 渲染标题与插槽', () => {
    const wrapper = mount(
      KbDialog,
      { props: { modelValue: true, title: '标题' }, slots: { default: '内容' }, ...stubTeleport },
    )
  ...
  it('点击遮罩触发 update:modelValue=false', async () => {
    const wrapper = mount(
      KbDialog,
      { props: { modelValue: true, closeOnClickOverlay: true }, ...stubTeleport },
    )
  ...
  it('渲染 footer 插槽', () => {
    const wrapper = mount(
      KbDialog,
      { props: { modelValue: true }, slots: { footer: '<button>确定</button>' }, ...stubTeleport },
    )
